...
type Station struct {
    ...
    AssignID       *uuid.UUID     `gorm:"type:uuid;column:assign_id" json:"assign_id,omitempty"`
	...
	MainCategoryID uuid.UUID      `gorm:"type:uuid;column:id_main_category" json:"id_main_category"`
