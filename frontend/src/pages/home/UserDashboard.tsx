...
const UserDashboard = () => {
 ...
 className="p-4 md:p-8 space-y-8 max-w-7xl mx-auto min-h-screen bg-slate-50 transition-colors duration-300"
 >
 {/* Premium Header */}
 ...
 <p className="text-gray-600 font-medium">Chào mừng trở lại <br />
 ...
 <div>
 <h2 className="text-xl font-black text-slate-800 tracking-tight leading-none">Dự án đang phụ trách</h2>
 <p className="text-[11px] text-slate-400 mt-0.5 font-medium">Nhấn vào thẻ để vào môi trường làm việc</p>
 </div>
 </div>
 <span className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-slate-100 text-[11px] font-bold text-slate-500 ">
 ...
 {entry.templateName ? (
 <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-slate-100 border border-slate-200 text-[8.5px] font-bold uppercase tracking-wide text-slate-500 overflow-hidden flex-1 mr-2">
 ...
 <h3 className="text-[15px] font-black text-slate-800 leading-tight tracking-tight truncate flex-1" title={entry.projectName}>
 {entry.projectName}
 </h3>
 <div className="shrink-0 w-7 h-7 rounded-full bg-slate-100 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-200 group-hover:bg-indigo-100 ">
 ...
 <span className="text-[10px] font-bold text-slate-500 ">{Math.round(timelinePercent)}%</span>
 <span className="text-[10px] font-semibold text-slate-400 flex items-center gap-1">
 ...
 <div>
 <h2 className="text-xl font-bold text-slate-800 leading-none">Thao tác nhanh</h2>
 <p className="text-xs text-slate-500 mt-0.5">Truy cập các tính năng chính</p>
 </div>
 </div>
