...
const UserHistoryPage = () => {
 ...
 <p className="text-sm font-bold text-slate-800 flex items-center gap-1 mb-2">
 ...
 {/* Check-out */}
 <div className={`rounded-xl p-3 ${isRejected ? 'bg-red-50 ' : isApproved ? 'bg-indigo-50 ' : 'bg-amber-50 '}`}>
 ...
 <p className="text-gray-600 font-medium">Xem lại lịch sử check-in và check-out cá nhân</p>
 </div>
 <div className="flex items-center gap-3">
 {highlightId && (
