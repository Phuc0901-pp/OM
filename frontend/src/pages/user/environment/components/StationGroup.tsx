...
const StationGroup: React.FC<StationGroupProps> = React.memo(({
    ...
    return (
        <div className="ml-8 border-l-2 border-indigo-100">
            {/* Station Header */}
            <div
                onClick={onToggle}
                className="p-2 pl-4 flex items-center justify-between cursor-pointer hover:bg-indigo-50/50 transition-colors"
            >
                ...
                <span className="text-xs text-slate-400">{tasks.length} quy trình</span>
            </div>
