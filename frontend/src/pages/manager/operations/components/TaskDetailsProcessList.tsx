        ...
        <div className="lg:col-span-8 space-y-6">
            ...
            {(() => {
                ...
                return subTasks.map((subTask: any, tIdx: number) => {
                    ...
                    // Use evidence from API if available, otherwise fall back to data_result
                    const currentEvidence = evidenceMap[subTask.id] || [];
                                        ...
                                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                                            {before.images.map((img: string, idx: number) => (
                                                <img
                                                    ...
                                                    alt="before"
                                                    onClick={(e) => { e.stopPropagation(); onViewImage(allTaskImages, allTaskImages.indexOf(img)); }}
                                                />
                                            ))}
                                        </div>
                                    </div>
