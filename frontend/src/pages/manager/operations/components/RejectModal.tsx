...
const RejectModal: React.FC<RejectModalProps> = ({
 ...
 Bạn đang từ chối hạng mục <strong className="text-slate-900">{task.subWorkName}</strong> tại đợt phân bổ <strong className="text-slate-900">{selectedAssignId ? task.projectName : ''}</strong>.
