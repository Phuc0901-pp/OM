            ...
            <div className="relative overflow-hidden bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-3xl p-6 md:p-8 shadow-xl dark:shadow-2xl border border-white/20 dark:border-white/5 transition-colors">
                ...
                <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="flex flex-col gap-1">
                        ...
                        <p className="text-gray-600 dark:text-slate-400 font-medium">Quản lý lịch sử xóa và nhật ký công tác</p>
                    </div>
                    <div className="flex items-center gap-3 bg-white/40 dark:bg-slate-800/40 p-1.5 rounded-xl border border-slate-200/50 shadow-sm backdrop-blur-md">
                        <button
