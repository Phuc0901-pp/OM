    ...
    return (
        <div className="min-h-screen bg-[#F8F9FC] p-8">
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                {/* 1. Dashboard Header */}
                <div className="relative overflow-hidden bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-3xl p-6 md:p-8 shadow-xl dark:shadow-2xl border border-white/20 dark:border-white/5 transition-colors flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                    ...
                    <div className="relative z-10 flex flex-col gap-1">
                        ...
                        <p className="text-gray-600 dark:text-slate-400 font-medium mt-1">Tổng quan về nhân sự và phân bổ dự án</p>
                    </div>
                    <div className="flex items-center gap-2 bg-white/40 dark:bg-slate-800/40 p-1.5 rounded-xl border border-white/50 shadow-sm backdrop-blur-md relative z-10">
                        <button
                                                    ...
                                                    <div key={idx} className="group/item">
                                                        <div className="flex justify-between items-center mb-1.5">
                                                            ...
                                                            <div className="flex items-center gap-2">
                                                                <span className="text-[10px] text-gray-400 font-medium">{proj.progress || 0}%</span>
                                                                {/* Delete Button - Only visible on hover (group/item) or always visible for better UX? Let's hide till hover */}
                                                                <button
                                                                    onClick={(e) => {
                                                                        e.stopPropagation();
                                                        ...
                                                        <div className="w-full h-1.5 bg-gray-100 rounded-full overflow-hidden">
                                                            <div
                                                                className={`h-full rounded-full transition-all duration-1000 ${(proj.progress || 0) === 100 ? 'bg-green-500' :
                                                                    (proj.progress || 0) > 50 ? 'bg-blue-500' : 'bg-amber-400'
                                                                    }`}
