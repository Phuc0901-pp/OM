...
const ManagerAllocationPage = () => {
 ...
 {/* Header */}
 <div className="relative overflow-hidden bg-white/80 backdrop-blur-xl rounded-3xl p-6 md:p-8 shadow-xl border border-white/20 transition-colors flex flex-col lg:flex-row lg:items-start justify-between gap-6">
 ...
 <p className="text-gray-600 font-medium mb-2 lg:mb-0">Giao công việc từ dự án cho các nhân sự.</p>
 </div>
 ...
 <Layers className="w-4 h-4 text-indigo-600" /> Loại hình dự án <span className="text-red-500 ml-1.5">*</span>
 </label>
 ...
 >
 <option value="" disabled>-- Chọn loại hình dự án (Bắt buộc) --</option>
 ...
 {data.assets.find(a => a.id === asset.parent_id)?.name || 'Trạm chính'}
 </div>
 )}
