...
const ReportsPage = () => {
 ...
 {/* Premium Header */}
 <div className="shrink-0 relative overflow-hidden bg-white/80 backdrop-blur-xl rounded-3xl p-6 md:p-8 shadow-xl border border-white/20 transition-colors">
 ...
 <p className="text-gray-600 font-medium">Quản lý và tra cứu hồ sơ hình dữ liệu</p>
 </div>
 </div>
