                    ...
                    >
                        <div className="flex items-center">
                            <input
                                ...
                                className="w-4 h-4 text-primary-500 bg-slate-800 border-white/10 rounded focus:ring-primary-500 focus:ring-1 transition-all cursor-pointer"
                            />
                            <label htmlFor="show-password-mobile" className="ml-2 block text-sm font-medium text-slate-300 hover:text-white cursor-pointer select-none transition-colors">
                                Hiển thị mật khẩu
                            </label>
                        </div>
                    </motion.div>
