...
import { User, Mail, Phone, MapPin, Briefcase, Shield, Calendar, Edit2, Camera, Settings, Moon } from 'lucide-react';
...
const AdminProfilePage = () => {
    ...
    return (
        ...
        >
            {/* Header Banner - Admin Purple Theme */}
            <div className="relative overflow-hidden rounded-3xl p-8 text-white shadow-2xl shadow-purple-500/30">
                <div className="absolute inset-0 bg-gradient-to-br from-purple-600 via-violet-600 to-fuchsia-600 opacity-95"></div>
                ...
                <div className="relative z-10 flex items-center justify-between">
                    <div className="flex items-center gap-6">
                        ...
                        <div>
                            <h1 className="text-3xl md:text-4xl font-black tracking-tight mb-2">Hồ sơ Admin</h1>
                            <p className="text-purple-100 font-medium text-lg opacity-90">Thông tin quản trị viên</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="lg:col-span-1 space-y-6">
                    <GlassCard className="text-center">
                        ...
                        <div className="relative inline-block mb-6">
                            <div className="w-32 h-32 rounded-full bg-gradient-to-br from-purple-500 to-fuchsia-600 p-1 shadow-xl shadow-purple-300">
                            ...
                            <button className="absolute bottom-0 right-0 p-2 bg-white rounded-full shadow-lg hover:shadow-xl transition-all border-2 border-purple-100 hover:border-purple-300">
                        ...
                        {/* Role Badge */}
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border-2 mb-6 bg-purple-100 text-purple-700 border-purple-300">
                        ...
                        {/* Admin Quick Actions */}
                        <div className="mt-4 p-4 bg-gradient-to-r from-purple-50 to-fuchsia-50 rounded-2xl border border-purple-100">
                            <p className="text-xs font-bold text-purple-600 uppercase mb-1">Quyền hạn</p>
                            <p className="text-sm font-bold text-slate-800">Toàn quyền hệ thống</p>
                        </div>
