...
const SplashScreen: React.FC<SplashScreenProps> = ({ onFinish, duration = 2500 }) => {
 ...
 className="fixed inset-0 z-[100] flex items-center justify-center bg-gradient-to-br from-slate-50 to-indigo-50 overflow-hidden"
 >
 {/* Background Accents */}
 <motion.div
 animate={{ rotate: 360 }}
 ...
 >
 <div className="w-32 h-32 md:w-40 md:h-40 bg-white rounded-3xl shadow-2xl flex items-center justify-center p-6 relative overflow-hidden ring-4 ring-white/50 ">
 <motion.div
 ...
 <p className="text-slate-500 font-medium text-sm md:text-base tracking-widest uppercase opacity-80">
