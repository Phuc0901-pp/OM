    ...
    return (
        <div className="mb-8 relative z-50" ref={dropdownRef}>
            ...
            <button
                ...
                className={`w-full md:w-[500px] group relative flex items-center gap-4 p-4 bg-white border-2 rounded-2xl transition-all duration-300 ${isOpen
            ...
            >
                ...
                {/* Chevron */}
                <div className={`p-2 rounded-full transition-all duration-300 ${isOpen ? 'bg-indigo-50 text-indigo-600 rotate-180' : 'text-slate-300'}`}>
